...
import { X, Lock, Loader, ShieldCheck, Eye, EyeOff } from "lucide-react";
...
export default function ChangePasswordModal({ onClose }: Props) {
  ...
  return (
    ...
    >
      <style>{`@media(min-width:640px){.cp-inner{align-self:center !important;border-radius:24px !important;}}`}</style>
      <div
        className="cp-inner anim-slide-up"
        style={{
          width: "100%",
          maxWidth: 440,
          alignSelf: "flex-end",
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            >
              <Lock size={17} style={{ color: "#a5b4fc" }} />
            </div>
            <span
